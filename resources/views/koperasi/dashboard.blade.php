...
<div class="space-y-8">
    <div class="bg-emerald-600 p-8 rounded-3xl shadow-xl text-white flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div class="bg-white/20 backdrop-blur-sm p-6 rounded-2xl border border-white/30 text-center min-w-[200px]">
            ...
            <p class="text-2xl font-black mt-1">Cukup Sehat</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div class="bg-white dark:bg-emerald-900 rounded-3xl shadow-sm border border-emerald-100 dark:border-emerald-800 p-6">
            ...
            <div class="space-y-4">
                <a href="#" class="flex items-center gap-4 p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-800 hover:bg-emerald-100 transition border border-emerald-100">
                ...
                <a href="#" class="flex items-center gap-4 p-4 rounded-2xl bg-emerald-50 dark:bg-emerald-800 hover:bg-emerald-100 transition border border-emerald-100">
                    <div class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-emerald-600"><i class="fas fa-edit"></i></div>
                    <span class="font-bold text-sm">Simpan Draft</span>
                </a>
            </div>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-emerald-100 dark:divide-emerald-800">
                        <tr>
                            <td class="p-6 font-bold">2025</td>
                            <td class="p-6"><span class="px-3 py-1 rounded-full bg-yellow-100 text-yellow-700 font-bold text-xs uppercase">Dalam Verifikasi</span></td>
                            <td class="p-6"><button class="text-emerald-600 font-bold text-sm underline">Lihat Detail</button></td>
                        </tr>
                        <tr>
                            <td class="p-6 font-bold">2024</td>
                            <td class="p-6"><span class="px-3 py-1 rounded-full bg-emerald-100 text-emerald-700 font-bold text-xs uppercase">Selesai</span></td>
                            <td class="p-6"><button class="text-emerald-600 font-bold text-sm underline">Unduh Sertifikat</button></td>
                        </tr>
                    </tbody>
                </table>
            </div>

        ...
        @if($profil)
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                <div class="space-y-6">
                    ...
                    <div>
                        <label class="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1">NIK Koperasi</label>
                        <p class="text-sm font-semibold text-slate-600 dark:text-slate-300">{{ $profil->nik_koperasi ?? '-' }}</p>
                    </div>
                    <div>
    ...
    <div class="bg-white dark:bg-emerald-900 rounded-3xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <form action="{{ route('koperasi.profil.update') }}" method="POST" class="grid grid-cols-2 gap-4">
            ...
            <div class="col-span-2">
                <label class="text-xs font-bold">Nama Koperasi</label>
                <input type="text" name="nama_koperasi" value="{{ $profil->nama_koperasi }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1" required>
            </div>
            <div>
                <label class="text-xs font-bold">NIK Koperasi</label>
                <input type="text" name="nik_koperasi" value="{{ $profil->nik_koperasi }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1" required>
            </div>
            <div>
                <label class="text-xs font-bold">No. Badan Hukum</label>
                <input type="text" name="no_badan_hukum" value="{{ $profil->no_badan_hukum }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div>
                <label class="text-xs font-bold">Kecamatan</label>
                <input type="text" name="kecamatan" value="{{ $profil->kecamatan }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div class="col-span-2">
                <label class="text-xs font-bold">Alamat</label>
                <textarea name="alamat" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">{{ $profil->alamat }}</textarea>
            </div>
            <div>
                <label class="text-xs font-bold">Tanggal Berdiri</label>
                <input type="date" name="tgl_berdiri" value="{{ $profil->tgl_berdiri }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div>
                <label class="text-xs font-bold">Jumlah Anggota</label>
                <input type="number" name="jumlah_anggota" value="{{ $profil->jumlah_anggota }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div>
                <label class="text-xs font-bold">Ketua</label>
                <input type="text" name="ketua" value="{{ $profil->ketua }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div>
                <label class="text-xs font-bold">Sekretaris</label>
                <input type="text" name="sekretaris" value="{{ $profil->sekretaris }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>
            <div>
                <label class="text-xs font-bold">Bendahara</label>
                <input type="text" name="bendahara" value="{{ $profil->bendahara }}" class="w-full p-3 rounded-xl border border-emerald-200 mt-1">
            </div>

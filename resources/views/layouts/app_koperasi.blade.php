...
<head>
    ...
    <title>@yield('title', 'Dashboard Koperasi') | AKURAT - DinkopUKM</title>
    ...
    <script>
        tailwind.config = {
            darkMode: 'class',
            theme: {
                extend: { colors: { emerald: { 600: '#008f5d', 700: '#064e3b', 900: '#022c22', 950: '#021813' } } }
            }
        }
    </script>
...
<body class="antialiased text-slate-800 bg-[#f0f9f4] dark:bg-emerald-950 dark:text-emerald-50">
    ...
    <span class="nav-text ml-3 font-bold text-sm">Input RAT</span>
                ...
                <a href="#" class="nav-item flex items-center py-4 px-5 rounded-2xl transition-all text-white/80 hover:text-white hover:bg-white/10">
                    ...
                    <span class="nav-text ml-3 font-bold text-sm">Simpan Draft</span>
                </a>
